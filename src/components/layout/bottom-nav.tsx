...
export function BottomNav({ user, stats }: BottomNavProps) {
  ...
  return (
    <nav 
      className="fixed bottom-0 left-0 right-0 z-[9999] bg-surface-900/95 backdrop-blur-xl border-t border-surface-800 md:hidden" 
      style={{ 
        paddingBottom: 'max(env(safe-area-inset-bottom, 0px), 0px)',
        bottom: 'env(safe-area-inset-bottom, 0px)',
      }}
    >
      <div className="flex items-center justify-around h-16 px-2" style={{ minHeight: '64px' }}>
